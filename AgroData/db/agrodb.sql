...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 18, 2020 at 08:43 PM
...
(1, 4, 'Cassava', 10, 17000, 'Bulemeezi', '', 1),
(3, 4, 'Irish Potatoes', 15, 23000, 'Mbiriizi', '', 1),
(4, 3, 'Cassava', 30, 8000, 'Masaka', '', 1);
...
--
ALTER TABLE `sensitizationtbl`
  MODIFY `msgID` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;COMMIT;
